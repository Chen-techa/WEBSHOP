<template>
    ...
    <el-container>
      <el-form :inline="true" :label-position="labelPosition" :model="updateform">
        <el-row>
          <el-col :span="24">
            <el-form-item label="商品名称:">
              <el-input v-model="updateform.productName" size="large"></el-input>
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="24">
            <el-form-item label="商品外部编码:">
              <el-input v-model="updateform.ma"></el-input>
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="24">
            <el-form-item label="所属分类:">
              <el-select v-model="updateform.lei">
        ...
        <el-row>
          <el-col :span="24">
            <el-form-item label="所属品牌:">
              <el-select v-model="updateform.pai">
        ...
        <el-row>
          <el-col :span="24">
            <el-form-item label="店内价格:">
              <el-input v-model="updateform.shopprice"></el-input>
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
        ...
        <el-row>
          <el-col :span="24">
            <el-form-item label="商品库存:">
              <el-radio-group v-model="updateform.number">
        ...
        <el-row>
          <el-col :span="24">
            <el-form-item label="是否热销:">
              <el-radio-group v-model="updateform.isHot">
        ...
        <el-row>
          <el-col :span="24">
            <el-form-item label="上下架状态">
              <el-select v-model="updateform.status" placeholder="状态">
...
export default {
  ...
  mounted(){
       this.$http.get('product/getProductInfo/')
  },
  methods:{
      handleRemove(file) {
        console.log(file);
